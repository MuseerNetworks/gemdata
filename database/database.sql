...
CREATE TABLE IF NOT EXISTS owner_withdrawals (
    ...
    bank_code VARCHAR(60) NULL,
    account_number VARCHAR(40) NULL,
    account_name VARCHAR(160) NULL,
    transfer_reference VARCHAR(120) NULL,
    payout_provider VARCHAR(40) NULL,
    payout_status ENUM('not_requested','processing','successful','failed') NOT NULL DEFAULT 'not_requested',
    payout_reference VARCHAR(120) NULL,
    payout_response_json TEXT NULL,
    payout_requested_at DATETIME NULL,
    payout_confirmed_at DATETIME NULL,
    payout_failure_reason VARCHAR(255) NULL,
    ...
    INDEX idx_owner_withdrawals_payout_reference (payout_provider, payout_reference),
...
CREATE TABLE IF NOT EXISTS provider_service_plans (
    ...
    provider_cost_price DECIMAL(12,2) NULL,
    is_enabled TINYINT(1) NOT NULL DEFAULT 1,
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
