...
$input['electricity_validation_status'] = $input['electricity_validation_status'] ?? 'unavailable';
$input['electricity_meter_confirmed'] = $input['electricity_meter_confirmed'] ?? '1';

try {
    $result = app(\GemData\Classes\TransactionService::class)->purchase('electricity', (int) $user['id'], $input, 'mobile', false);
