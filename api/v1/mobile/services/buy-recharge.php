...
try {
    $result = app(\GemData\Classes\TransactionService::class)->purchase('recharge_card', (int) $user['id'], $input, 'mobile', false);
    ...
    echo json_encode([
        'success' => true,
        'message' => 'Recharge card purchase transaction accepted and queued.',
        'data' => [
