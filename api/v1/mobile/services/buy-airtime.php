...
// Check rate limit for transactions (max 10 attempts per minute per IP)
...
try {
    $result = app(\GemData\Classes\TransactionService::class)->purchase('airtime', (int) $user['id'], $input, 'mobile', false);
