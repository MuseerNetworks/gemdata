...
function icon_svg(string $name): string
{
    return match ($name) {
        ...
        'services-mobile' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M4 7h16M7 4v6m10-6v6M6.5 10h11A2.5 2.5 0 0120 12.5v5A2.5 2.5 0 0117.5 20h-11A2.5 2.5 0 014 17.5v-5A2.5 2.5 0 016.5 10z"/><path stroke-linecap="round" stroke-linejoin="round" d="M9 15h6m-3-3v6"/></svg>',
