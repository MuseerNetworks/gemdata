...
use GemData\Classes\FinanceLedgerService;
use GemData\Classes\OwnerWithdrawalService;
...
try {
    ...
    $financeLedger = new FinanceLedgerService($database);
    ...
    $ownerWithdrawals = new OwnerWithdrawalService($database, $financeLedger);
    $adminOps = new AdminOpsService($database, $activityLogger, $providerManager, $financeLedger);
    $transactionService = new TransactionService($database, $wallet, $commission, $notifications, $providerManager, $pricing, $providerPlans, $fraud, $activityLogger, $financeLedger);
    ...
    register_service(FinanceLedgerService::class, $financeLedger);
    register_service(OwnerWithdrawalService::class, $ownerWithdrawals);
